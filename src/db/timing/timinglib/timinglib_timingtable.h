...
class TimingTable : public Object {
  public:
    ...
    virtual float findValue(float v1, float v2, float v3,
                            float timeUnitScale = 1.0f, float v1Scale = 1.0f,
                            float v2Scale = 1.0f, float v3Scale = 1.0f);
    virtual void getAxisValueByAxisVariable(float inSlew, float loadCap,
                                            float relatedOutCap,
                                            float &axis1Value,
                                            float &axis2Value,
                                            float &axis3Value);
    virtual void getAxisValueScaleByAxisVariable(
...
class TimingTable0 : public TimingTable {
  public:
    ...
    /// get
    float getValue(float scale=1.0f);
    float findValue(float v1, float v2, float v3, float timeUnitScale = 1.0f,
                    float v1Scale = 1.0f, float v2Scale = 1.0f,
                    float v3Scale = 1.0f);
    void getAxisValueByAxisVariable(float inSlew, float loadCap,
                                    float relatedOutCap, float &axis1Value,
                                    float &axis2Value, float &axis3Value);
    void getAxisValueScaleByAxisVariable(float inSlewScale, float loadCapScale,
...
class TimingTable1 : public TimingTable {
  public:
    ...
    /// get
    float getValue(IndexType index, float scale=1.0f);
...
class TimingTable2 : public TimingTable {
  public:
    ...
    /// get
    float getValue(IndexType index1, IndexType index2, float scale=1.0f);
    float findValue(float v1, float v2, float v3, float timeUnitScale = 1.0f,
                    float v1Scale = 1.0f, float v2Scale = 1.0f,
                    float v3Scale = 1.0f);
    void getAxisValueByAxisVariable(float inSlew, float loadCap,
