...
TUnits::TUnits() : TUnits::BaseType(), group_id_(UNINIT_OBJECT_ID) {
...
ObjectId TUnits::getGroupId(void) { return group_id_; }
...
void TUnits::setGroupId(ObjectId id) { group_id_ = id; }
