...
class LibBuilder {
  ...
  private:
    ...
    void __buildFfBank(timinglib_head *);
    void __buildLatch(timinglib_head *);
    void __buildLatchBank(timinglib_head *);
    void __buildFfOrLatch(timinglib_head *, bool bFf);
    void __buildFfBankOrLatchBank(timinglib_head *, bool bFfBank);
    ...
    // ff
    void __buildNextState(buildParam);
    void __buildClockedOn(buildParam);
    void __buildPreset(buildParam);
    void __buildClear(buildParam);
    void __buildClearPresetVar1(buildParam);
    void __buildClearPresetVar2(buildParam);

    // latch
    void __buildDataIn(buildParam);
    void __buildEnable(buildParam);
    ...
    void __getSequentialsFromTopStack(
        std::vector<tb_namespace::TSequential *> *libSequentials);
