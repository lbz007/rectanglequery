...
ScaleFactors::ScaleFactors()
    : ScaleFactors::BaseType(), name_(0), group_id_(UNINIT_OBJECT_ID) {
    __initValue();
...
ScaleFactors::ScaleFactors(Object* owner, ScaleFactors::IndexType id)
    : ScaleFactors::BaseType(owner, id), name_(0), group_id_(UNINIT_OBJECT_ID) {
    __initValue();
    setObjectType(ObjectType::kObjectTypeScaleFactors);
}
...
void ScaleFactors::setGroupId(ObjectId id) { group_id_ = id; }
...
ObjectId ScaleFactors::getGroupId(void) const { return group_id_; }
