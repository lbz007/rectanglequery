...
enum class TimingRiseFall {  // Used by calculating delay
    kRise,
    kFall,
    kRise_Fall,
    kUnknown
...
inline std::string toString(TimingClearPreset const &c) {
    switch (c) {
        case TimingClearPreset::kL:
            return "L";
        case TimingClearPreset::kH:
            return "H";
        case TimingClearPreset::kN:
            return "N";
        case TimingClearPreset::kT:
            return "T";
        case TimingClearPreset::kX:
            return "X";
        default:
            return "Unknown";
    }
