...
void WireLoadTable::setGroupId(ObjectId id) { group_id_ = id; }
...
ObjectId WireLoadTable::getGroupId(void) { return group_id_; }
...
void WireLoad::setGroupId(ObjectId id) { group_id_ = id; }
...
ObjectId WireLoad::getGroupId(void) { return group_id_; }
...
WireLoadForArea::~WireLoadForArea() {
    if (wireload_ != UNINIT_OBJECT_ID) {
        ...
        if (wl) {
            Timing* timing_lib = getTimingLib();
            if (timing_lib) timing_lib->destroyObject<WireLoad>(wl);
        }
    }
}
...
void WireLoadForArea::setGroupId(ObjectId id) { group_id_ = id; }
...
ObjectId WireLoadForArea::getGroupId(void) { return group_id_; }
...
void WireLoadSelection::move(WireLoadSelection&& rhs) {
    ...
    rhs.wireloads_ = UNINIT_OBJECT_ID;
    group_id_ = std::move(rhs.group_id_);
...
void WireLoadSelection::setGroupId(ObjectId id) { group_id_ = id; }
...
ObjectId WireLoadSelection::getGroupId(void) const { return group_id_; }
