...
class Track : public Object {
  public:
    ...
    void addLayer(ObjectIndex layer_id);
...
class Constraint : public Object {
  public:
    ...
    bool hasLayer() const;
    ObjectIndex getLayerId() const;
    const char* getLayerName() const;
    bool hasPlacement() const;
    bool hasComponent() const;
    ObjectId getComponentId() const;
    Inst *getComponent() const;
    ...
    double getPlacementMaxDensity() const;  // 5.7
    bool hasSpacing() const;             // 5.6
    Bits64 getMinSpacing() const;           // 5.6
    bool hasDesignRuleWidth() const;     // 5.6
    Bits64 getEffectiveWidth() const;       // 5.6
    bool hasMask() const;                // 5.8
    Bits64 getMaskNum() const;              // 5.8

    void createBox(int64_t xl, int64_t yl, int64_t xh, int64_t yh);
    void addPolygon(Polygon *polygon);
    ObjectId getLayerGeometryId() const { return layer_geometry_id_; }
    LayerGeometry *getLayerGeometry() const { return __getLayerGeometry(); }

    void printBlockage() const;
    void printBlockage(IOManager &io_manager) const;

    void printRegion(IOManager &io_manager);

  private:
    Layer *__getLayer() const;
    void __createLayerGeometry();
    LayerGeometry *__getLayerGeometry() const;
    LayerGeometry *__getOrCreateLayerGeometry();
