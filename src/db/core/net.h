...
class Net : public Object {
  public:
    ...
    NonDefaultRule* getNonDefaultRule() const;
    int getXtalk() const;
    ...
    ArrayObject<ObjectId>* getWireArray() const;
    ArrayObject<ObjectId>* getViaArray() const;
  ...
  private:
    ...
    SourceType source_ : 8;   /**< net source type */
    Bits pattern_ : 3;
    Bits weight_ : 4;
