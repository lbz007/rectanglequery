...
const ObjectIndex kInvalidLayerIndex = -1;
...
class TrimLayerRule : public Object {
  public:
    TrimLayerRule() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(TrimLayerRule) - sizeof(Object));
    }
...
class MEOLLayerRule : public Object {
  public:
    MEOLLayerRule() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(MEOLLayerRule) - sizeof(Object));
    }
...
class AntennaModel : public Object {
  public:
    AntennaModel() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(AntennaModel) - sizeof(Object));
    }
    ~AntennaModel() {
        reset();
    }
