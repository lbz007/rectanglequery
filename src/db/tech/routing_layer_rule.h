...
class BoundaryEOLBlockage : public Object{
  public:
    BoundaryEOLBlockage() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(BoundaryEOLBlockage) - sizeof(Object));
    }
...
class CornerEOLKeepout : public Object{
  public:
    CornerEOLKeepout() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(CornerEOLKeepout) - sizeof(Object));
    }
...
class CornerFillSpacing : public Object {
  public:
    CornerFillSpacing() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(CornerFillSpacing) - sizeof(Object));
    }
...
class CornerSpacing : public Object {
  public:
    CornerSpacing() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(CornerSpacing) - sizeof(Object));
    }
    ~CornerSpacing();
...
class DirSpanLengthSpTbl : public Object {
  public:
    ...
    class ExactSLSpacing : public Object {
      public:
        ExactSLSpacing() {
            memset((uint8_t*)this + sizeof(Object), 0, sizeof(ExactSLSpacing) - sizeof(Object));
        }
        ~ExactSLSpacing();
    ...
    class SpanLength : public Object {
      public:
        SpanLength() {
            memset((uint8_t*)this + sizeof(Object), 0, sizeof(SpanLength) - sizeof(Object));
        }
        ~SpanLength();
      public:
  ...
  public:
    DirSpanLengthSpTbl() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(DirSpanLengthSpTbl) - sizeof(Object));
    }
    ~DirSpanLengthSpTbl();
  ...
  public:
    ...
    int getExactSLSpacingListSize() const;
...
class MinCut : public Object {
  public:
    MinCut() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(MinCut) - sizeof(Object));
    }
    ~MinCut();
  ...
  public:
    ...
    ArrayObject<ObjectId>*  getCutClassArr() const;
    int  getCutClassSize() const;
    ArrayObject<UInt32>*  getCutClassNumCutsArr() const;
    int  getCutClassNumCutsSize() const;
...
class MinEnclArea : public Object {
  public:
    MinEnclArea() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(MinEnclArea) - sizeof(Object));
    }
...
class MinSize : public Object {
  public:
    MinSize() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(MinSize) - sizeof(Object));
    }
    ~MinSize();
...
class MinStep : public Object {
  public:
    MinStep() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(MinStep) - sizeof(Object));
    }
...
class WidthSpTbl : public Object {
  public:
    WidthSpTbl() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(WidthSpTbl) - sizeof(Object));
    }
    ~WidthSpTbl();
...
class InfluenceSpTbl : public Object {
  public:
    InfluenceSpTbl() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(InfluenceSpTbl) - sizeof(Object));
    }
    ~InfluenceSpTbl();
...
class ParaSpanLenTbl : public Object {
  public:
    ParaSpanLenTbl() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(ParaSpanLenTbl) - sizeof(Object));
    }
    ~ParaSpanLenTbl();
...
class ProtrusionRule : public Object {
  public:
    ProtrusionRule() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(ProtrusionRule) - sizeof(Object));
    ...
    class ProtrusionWidth : public Object  {
      public:
        ProtrusionWidth() {
            memset((uint8_t*)this + sizeof(Object), 0, sizeof(ProtrusionWidth) - sizeof(Object));
        }
  ...
  public:
    ...
    ArrayObject<ObjectId>* getProtrusionWidths() const;
    int getProtrusionWidthSize() const;
...
class RoutingSpacing : public Object {
  public:
    RoutingSpacing() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(RoutingSpacing) - sizeof(Object));
    }
...
class RoutingLayerRule : public Object {
  public:
    RoutingLayerRule() {
        memset((uint8_t*)this + sizeof(Object), 0, sizeof(RoutingLayerRule) - sizeof(Object));
    }
  ...
  public:
    ...
    int getBoundaryEOLBlocakgeSize() const;
    ...
    int getCornerEOLKeepoutSize() const;
    ...
    int getCornerFillSpacingSize() const;
    ...
    int getCornerSpacingSize() const;
    ...
    int getParaSpanLenTblSize() const;
