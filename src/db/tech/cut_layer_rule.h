...
class CutLayerRule : public Object{
  public:
    ...
    int getArraySpacingSize() const;
    ArraySpacing *getArraySpacing(int i) const;
    void addArraySpacing(ObjectId id);
    SpacingTableOrthogonal *getSpTblOrth() const;
    void setSpTblOrtho(ObjectId id);
 ...
 * @class SpacingTableOrthogonal
 * @brief
 * implementation class of SPACINGTALE ORTHOGONAL rule
 * [ SPACINGTABLE  ORTHOGONAL 
 *     {WITHIN  cutWithin  SPACING  orthoSpacing } ... ;]
 */
class SpacingTableOrthogonal: public Object{
  public:
    SpacingTableOrthogonal();
    ~SpacingTableOrthogonal(); 

    Int32 getNumOrtho() const;
    void setNumOrtho(Int32 num);
    Int32 getCutWithin(Int32 idx) const;
    void setCutWithin(Int32 cut_within);
    Int32 getOrthoSpacing(Int32 idx) const;
    void setOrthoSpacing(Int32 ortho_spacing);

  private:
    Int32 num_ortho_;
    ObjectId cut_within_;
    ObjectId ortho_spacing_;
};
