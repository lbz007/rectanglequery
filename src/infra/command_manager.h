...
class CommandManager {
 public:
    ...
    static int executeCommand(ClientData clientData, Tcl_Interp* interp, int objc, Tcl_Obj* CONST objv[]);
    static void printHelp(Command* cmd);
    ...
    Command* createCommand(Tcl_Interp *itp, commandCallback cb, const char* cmd_name, const char* description);
    ...
    Command* createObjCommand(Tcl_Interp *itp, registeredCallback cb, const char* cmd_name, const char* description, bool add_processbar = true);
    Command* createObjCommand(Tcl_Interp *itp, registeredCallback cb, const char* cmd_name, const char* description,
                               Option& opt_head, bool add_processbar = true);
    Command* createObjCommand(Tcl_Interp *itp, registeredCallback cb, const char* cmd_name, const char* description,
                               Option& opt_head, OptionGroup& group_head, bool add_processbar = true);
