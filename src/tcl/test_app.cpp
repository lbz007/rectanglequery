...
void testGraph() {
    ...
    for (iter.begin(); !iter.end(); iter++) {
        ...
        std::cout << "from: \'" << gr->getFrom()->getName() << "\' edge : \'"
                  << gr->getEdge()->getName() << "\' to: \'"
                  << gr->getTo()->getName() << "\'" << std::endl;
    }
}
/**
...
void registerTestCommands(Tcl_Interp *itp) {
    ...
    Tcl_CreateCommand(itp, "map_reduce_test", mapReduceTestingCommand, NULL,
                      NULL);
