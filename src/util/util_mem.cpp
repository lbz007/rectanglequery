...
void MemPagePool::__writeChunkSizeInfo(IOManager &io_manager, bool debug) {
    ...
    io_manager.write(sizeof(num_chunks_), (void *)&(num_chunks_));
    io_manager.write(sizeof(chunk_size_), (void *)&(chunk_size_));
}
...
void MemPagePool::__writePageInfo(IOManager &io_manager, bool debug) {
    io_manager.write(sizeof(curr_page_id_), (void *)&(curr_page_id_));
    io_manager.write(sizeof(page_size_), (void *)&(page_size_));
    io_manager.write(sizeof(num_pages_), (void *)&(num_pages_));
    if (debug)
    ...
    for (auto &page : pages_) {
        ...
        io_manager.write(sizeof(MemPage), reinterpret_cast<void *>(page));
    }
}
...
void MemPagePool::__writeFreeListInfo(IOManager &io_manager, bool debug) {
    io_manager.write(sizeof(mem_free_), (void *)&(mem_free_));

    size_t size = free_list_.size();
    io_manager.write(sizeof(size), (void *)&(size));
    if (debug)
    ...
    for (auto &fl : free_list_) {
        ...
        io_manager.write(sizeof(obj_type_id), (void *)&(obj_type_id));
        ...
        io_manager.write(sizeof(freeobjs_size), (void *)&(freeobjs_size));
        ...
        for (std::forward_list<void *>::iterator iter = fl.second->begin();
            ...
            io_manager.write(sizeof(freeobj_ptr), (void *)(&freeobj_ptr));
            if (debug)
