        ...
        ) 
{
    ...
    // Call the cuda kernel launcher
        DREAMPLACE_DISPATCH_FLOATING_TYPES(pos, "computeDensityPotentialMapCudaLauncher", [&] {
        ...
        ) 
{
    ...
    {
        DREAMPLACE_DISPATCH_FLOATING_TYPES(pos, "computeDensityOverflowMapCudaLauncher", [&] {
