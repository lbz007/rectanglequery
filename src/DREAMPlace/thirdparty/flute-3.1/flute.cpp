...
void readLUT(const char* POWVFILE, const char* POSTFILE);
...
static bool isLUTRead = false;
void readLUT(const char* POWVFILE, const char* POSTFILE)
{
  if(isLUTRead) {
    std::cout<<"FLUTE LUT already read, skip reading!"<<std::endl;
  } else {
    std::cout<<"Reading FLUTE LUT..."<<std::endl;
    isLUTRead = true;
  }
