...
static void registerSystemCommands(Tcl_Interp *itp) {
    ...
    open_edi::db::registerRQTclCommands(itp);
 ...
 *application. Each initialization procedure adds new commands to interp for its
 *package and performs other package-specific initialization.
 ...
 * 4. Use the routines Tcl_SetStartupScript and Tcl_GetStartupScript to set or
 *query the file and encoding that the active Tcl_Main or Tk_Main routine will
